 ...
 * @author Dave Syer
 */
public class ExactOAuth2RestTemplate extends ExactRestTemplate implements
	...
	public ExactOAuth2RestTemplate(OAuth2ProtectedResourceDetails resource) {
	...
	public void setMessageConverters(
		...
		/*
		 * List<HttpMessageConverter<?>> messageConvertersTemp = new
		 * ArrayList<HttpMessageConverter<?>>();
		 * Jaxb2RootElementHttpMessageConverter jaxbMessageConverter = new
		 * Jaxb2RootElementHttpMessageConverter(); List<MediaType> mediaTypes =
		 * new ArrayList<MediaType>(); mediaTypes.add(MediaType.TEXT_HTML);
		 * jaxbMessageConverter.setSupportedMediaTypes(mediaTypes);
		 * messageConvertersTemp.add(new MappingJackson2HttpMessageConverter());
		 */
	...
	/**
	 * Strategy for extracting an Authorization header from an access token and
	 * the request details. Defaults to the simple form "TOKEN_TYPE
	 * TOKEN_VALUE".
	 * 
	 * @param authenticator
	...
	protected ClientHttpRequest createRequest(URI uri, HttpMethod method)
		...
		AuthenticationScheme authenticationScheme = resource
	...
	protected OAuth2AccessToken acquireAccessToken(
		...
		ExactDefaultOAuth2AccessToken exactDefaultOAuth2AccessToken = new ExactDefaultOAuth2AccessToken(
				accessToken);
		oauth2Context.setAccessToken(exactDefaultOAuth2AccessToken);
		return accessToken;
	}
