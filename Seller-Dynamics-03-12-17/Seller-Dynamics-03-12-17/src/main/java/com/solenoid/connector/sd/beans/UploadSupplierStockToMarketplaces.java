 ...
 *         &lt;element name="marketplaceNames" type="{https://my.sellerdynamics.com/}ArrayOfString" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = { "encryptedLogin", "retailerId",
		"supplierName", "marketplaceNames", "stockString", "importName",
		"importDescription" })
@XmlRootElement(name = "UploadSupplierStockToMarketplaces")
public class UploadSupplierStockToMarketplaces {

	protected String encryptedLogin;
	@XmlElement(required = true)
	protected String retailerId;
	protected String supplierName;
	protected ArrayOfString marketplaceNames;
	...
	/**
	 * Gets the value of the marketplaceNames property.
	 * 
	 * @return possible object is {@link ArrayOfString }
	 * 
	 */
	public ArrayOfString getMarketplaceNames() {
		return marketplaceNames;
	}

	/**
	 * Sets the value of the marketplaceNames property.
	 * 
	 * @param value
	 *            allowed object is {@link ArrayOfString }
	 * 
	 */
	public void setMarketplaceNames(ArrayOfString value) {
		this.marketplaceNames = value;
	}
